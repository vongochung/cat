...
UPLOAD = PROJECT_ROOT + '/assets/images/upload/'
...
SECRET_KEY = 'gsqwojdvoh9n-10x0g*jjrp0mbm$=qdy=v0&amp;#^ln=fa9y=_v^y'
SALT_KEY = '12345678abcdefgh' # 16, 24, 32 bytes
...
#WSGI_APPLICATION = 'widoosport.wsgi.application'
